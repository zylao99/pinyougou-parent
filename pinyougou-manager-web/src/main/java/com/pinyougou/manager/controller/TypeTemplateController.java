...
public class TypeTemplateController {
	...
	public Result exportExcel(@RequestBody Long[] ids){
		...
		try {
			typeTemplateService.findTypeTemplateById(ids);
	...
	public Result insertExcel(MultipartFile file){
		try {
			List<TbTypeTemplate> tbTypeTemplates = ExcelUtils.importTypeTemplate(file);
			typeTemplateService.insertTypeTemplateList(tbTypeTemplates);
